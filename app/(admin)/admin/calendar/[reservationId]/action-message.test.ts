...
describe("actionMessage — resendErr", () => {
  /**
   * This means NOTHING was attempted — a property of the deployment, not of the booking.
   ...
   * and `messaging_off` the same way at issue #761, when `MESSAGING` stopped gating customer sends.
   */
  it.each([
