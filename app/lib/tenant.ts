 ...
 * thread id (the crew messaging UI) is the first to need this app-side. Held as
 * one documented, env-overridable VALUE, not a lookup — the single-subject, single-tenant posture (DEC-020). A
