 ...
 *   sign in at /crew with a code, then Switch to admin → /admin/shifts?mode=edit
...
try {
  ...
  console.log("");
  console.log("Test:  sign in at /crew with a code, then Switch to admin → /admin/shifts?mode=edit");
