...
> _Note: DEC-060 lands via `feature/messaging` (PR #144); DEC-062/063 via the stacked #149/#152 PRs; all reach `main` when those merge. This pilot fix allocates **DEC-064** — the 060/062/063 gaps on this branch are expected concurrent-branch numbering._
