...
`pending`, and it is the thing that occupies the departure. It carries the instant it was written —
...
**2.8.3 What a reservation occupies is the hull for the departure's hold minutes.**
...
- [ ] A declined card retried on the same departure reuses the same reservation at its original reserved time,
...
**The two surfaces compute the money from one model.** The same departure never quotes two totals,
