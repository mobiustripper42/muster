...
## 2.10 Reservations — the surfaces around the sale

§2.8 is a transaction: ninety seconds in which a customer picks a departure and pays for it.
...
**2.10.3 Party size is chosen first, and it filters everything.**
