...
| 20 | DEC-061 | `:1686` | "the **§2.6** acceptance ('…and Spink confirming moves the seat')" | phrase never existed in §2.6; `SPEC.md:1110-1112` | **UNCLEAR** → **Z3-6** |
...
- **Code touched exactly twice, both times to settle a doc-vs-doc dispute:** `app/(crew)/crew/page.tsx:534`
  (the "Awaiting confirmation" badge, Z3-6) and `git log -S'Spink confirming' -- docs/SPEC.md` (which
