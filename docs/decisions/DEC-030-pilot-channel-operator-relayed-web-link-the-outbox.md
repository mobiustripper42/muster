...
- Refined by DEC-150 — rule 4 (prefetch-safe consume) only — the interstitial stays for every client without a matching session, and the GET still never consumes
