...
- Amends DEC-031 — fills-by display and label only — the concept, the code symbols (`fillsBy`, `FILL_DEADLINE_HOURS`) and the mechanic are unchanged; the board no longer renders the line and the cockpit relabels it "deadline"
