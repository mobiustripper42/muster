...
amends:
  - id: DEC-010
    relation: revises
    scope: "the mechanism only — the crew front door is phone-entry → roster lookup → 6-digit code, not magic-link. The passwordless and no-self-registration legs stand"
---
