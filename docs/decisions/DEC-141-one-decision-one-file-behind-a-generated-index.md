...
- Amends DEC-127 — the maintenance rule only — the index stands, but it is generated rather than hand-updated

**See also** — later decisions that changed part of this one:
- Extended by DEC-143 — the same generated-reciprocal-pointer mechanism, pointed at SPEC instead of at other decisions
