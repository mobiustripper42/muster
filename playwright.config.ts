...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      name: "mobile",
      testMatch: /(auth-crew|admin-nav|outbox-relay|crew-messaging|operator-messaging|version-tag|crew-sign-in|crew-open|crew-reconciliation|crew-help|cockpit-manifest|cockpit-override|time-off)\.spec\.ts/,
