...
const CITATIONS = [
  ...
  ['app/lib/booking-confirmation.ts', 81, 'await ensureBookingCode('],
  ['app/lib/booking-confirmation.ts', 152, 'await ensureBookingCode('],
  ...
  ['app/lib/booking-confirmation.ts', 41, 'if (process.env.MESSAGING === "false") return;'],
  ['app/lib/booking-confirmation.ts', 70, '"reservations:confirm",'],
  ['docs/DEPLOY.md', 111, '`MESSAGING=0` leaves booking confirmations ON'],
  ['app/lib/booking-confirmation.ts', 80, "The operator's resend recovers it."],
  ['app/lib/booking-confirmation.ts', 81, 'await ensureBookingCode(repo, reservation.id'],
